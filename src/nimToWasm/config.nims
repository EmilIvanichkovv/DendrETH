...
var linkerOptions = " -fuse-ld=lld -nostdlib -Wl,--no-entry,--allow-undefined,--export-dynamic,--gc-sections,--strip-all -DNDEBUG -Ofast -std=c99 -D__EMSCRIPTEN__ -D_LIBCPP_ABI_VERSION=2 -fvisibility=hidden -fno-builtin -fno-exceptions -fno-threadsafe-statics -I/home/Emil/code/repos/DendrETH/src/nimToWasm"
